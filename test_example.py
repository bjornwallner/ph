...
working_dir = os.path.abspath('1a8i/') # Full path to the folder '1a8i'
...
##ReadPDB will save *.struct numpy variables containing the PROtein coords within 50.0 of ligand and the LIGand cordinates.
ReadPDB.get_pdb_structure(a, 50.0, protein_name, working_dir)
##ReadPQR will save *_chg.npz containing the LIGand coords with charge and PROtein coords with charge taken from PDB2PQR using Amber force field
...
#sys.exit()
ReadPDB.get_pdb_structure(a, 12.0, protein_name, working_dir)
